...
import com.example.bai_9.repository.IFootballRepository;
...
public class FootballService implements IFootballService {
    ...
    public List<Football> findAll() {
        return this.iFootballRepository.findAll();
    }
    @Override
    public List<Football> findAllByStatusIsTrue() {
        return this.iFootballRepository.findAllByStatusIsTrue();
    }
